...
const kvProgress = [
  { label: '队列状态', value: 'analyzing', help: 'queued → analyzing' },
  { label: '已完成', value: '2 个', help: '输出包就绪可下载', valueColor: '#6ee7b7' },
  { label: '失败', value: '0 个', help: 'failed 可按条件重试', valueColor: '#fda4af' },
  {
    label: '当前文件',
    value: 'test2_5.mp4',
    help: '视觉增强 · 第 4/6 步',
      ...
      <div className="container">
        <div className="section-head">
          ...
          <p className="section-sub">
            React 19 + TypeScript + Vite + Tailwind 4 构建。模型配置由后端 .env 统一托管；分析任务持久化 queued / analyzing / completed / failed / cancelled 五个状态，刷新后可恢复并支持取消或重试；uploading 单独表示上传会话。
          </p>
        </div>
        ...
        <div className="workspace fade-up">
          <div className="ws-titlebar">
            ...
            <div className="ws-url">http://localhost — Video Insights · AI 视频理解工作台</div>
            ...
            <div className="ws-grid ws-grid--two">
              ...
              <div className="panel" style={{ padding: '1.1rem' }}>
                ...
                <div className="files" style={{ marginTop: '0.85rem' }}>
                  ...
                  <FileRow
                    ...
                    info="analyzing · 视觉增强 · 64%（刷新可恢复）"
                    state="run"
                  />
                  <FileRow
                    name="onboarding_screencast.mov"
                    info="queued · 已持久化 · 可取消"
                    state="idle"
                  />
                </div>
              ...
              <div className="panel" style={{ padding: '1.1rem' }}>
                <div className="card-head">
                  ...
                  <span className="status status--run">analyzing</span>
                </div>
